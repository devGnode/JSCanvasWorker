...
Prenons exemple sur l'image ci-desus CP437 8x8 dont chaque caractere peut-être représenter dans un tableau matricielle de 8*8 soit 64 case vide comme ci-desous, lorsque la case est vide sa correspondance et équal à 0 et lorsque une case et cocher sa correspondance est de 1
